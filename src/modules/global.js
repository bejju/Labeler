...
const ACTION_HANDLERS = {
    ...
    [TOGGLE_NOTIFICATION]: (state, action) => state.set('showBanner', false).set('showTime', 0).set('showTime', action.showTime)
...
const initialState = fromJS({ isAuthenticated: false, emailid: null, password: null, role: null, isLoading: false, role: null, authToken: null })
