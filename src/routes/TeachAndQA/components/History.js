...
export default class History extends React.Component {
    render() {
        return (
            <div className="history padding-left-20 padding-top-30 padding-bottom-15">
                    ...
                    <Table selectable={false} className="history">
                        <TableBody displayRowCheckbox={false}>
                            <TableRow style={{ border: 'none' }}>
                                ...
                                <TableRowColumn  ><span className="fontStyle2"><div >Labeled</div></span></TableRowColumn>
                                <TableRowColumn  ><span className="fontStyle2">Machine</span></TableRowColumn>
                            ...
                            <TableRow style={{ border: 'none' }}>
                                ...
                                <TableRowColumn ><span className="fontStyle2"><div className="unApprove">Unapproved</div></span></TableRowColumn>
                                <TableRowColumn  ><span className="fontStyle2">Beth</span></TableRowColumn>
